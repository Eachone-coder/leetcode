...
//print_r((new Solution())->maxNumberOfBalloons('nlaebolko'));
//print_r((new Solution())->maxNumberOfBalloons('loonbalxballpoon'));
//print_r((new Solution())->maxNumberOfBalloons('lloo'));
print_r((new Solution())->maxNumberOfBalloons('balon'));